  ...
  try {
    ...
    if (!address) {
      return res.status(400).json({
        ...
        message: "Debes proporcionar una dirección de wallet válida",
      });
    }
    ...
    const siweMessageData = {
      domain: domain,
      address: address,
      statement: "Bienvenido a CryptoFaucet - Firma para autenticarte",
      uri: origin,
      version: "1",
      chainId: 11155111,
      nonce: generateNonce(),
    ...
    console.log("📝 Generando mensaje SIWE:", siweMessageData);

    const message = new SiweMessage(siweMessageData);
    const messageString = message.prepareMessage();

    console.log("📄 Mensaje preparado exitosamente");

    console.log("✅ Listo para firmar");
